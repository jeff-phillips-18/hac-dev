...
const BUILD_DESC = `Every component requires a build in order to deploy it ton an environment. Whenever you create a new component, we send a pull request to merge our build pipeline to your component's source code`;
